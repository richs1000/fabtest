	...
	var q= [
		["Given: ~ ^^^^^^^^^^^^^^^^^^ val e = (7, (true, 9), (5, false), 8, (3, 4)) ~~ What is the value of #1 e?"],
		["Given: ~ ^^^^^^^^^^^^^^^^^^ val e = (7, (true, 9), (5, false), 8, (3, 4)) ~~ What is the value of #3 e?"],
		["Given: ~ ^^^^^^^^^^^^^^^^^^ val e = (7, (true, 9), (5, false), 8, (3, 4)) ~~ What is the value of #1 (#2 e)?"],
		["Given: ~ ^^^^^^^^^^^^^^^^^^ val e = (7, (true, 9), (5, false), 8, (3, 4)) ~~ What is the value of #2 (#3 e)?"],
		["Given: ~ ^^^^^^^^^^^^^^^^^^ val e = (7, (true, 9), (5, false), 8, (3, 4)) ~~ What is the value of #4 e?"],
	];
  ...
  //Initialize matrix qa[0-4][question,answer,(boolean)answered or not]  
	var length=q.length-1;
	var qa=new Array(length+1);
...
var ran;	
	...
	findQuest = function(){
			...
			ran= getRandomInt(0,length+1);
		
			if(qa[ran][2]==false){
			 
				questionTemplate = qa[ran][0];
				currentAnswer = qa[ran][1];
				return true;
